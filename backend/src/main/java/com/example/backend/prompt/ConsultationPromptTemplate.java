...
public class ConsultationPromptTemplate {
    ...
    private static final String COMMON_GROUNDING_RULES = """
            ...
            - 반드시 한국어로만 답하세요. 영어 단어나 문장을 절대 사용하지 마세요.
            - "further assistance", "feel free", "please let me know", "if you need" 같은 영어 표현을 절대 포함하지 마세요.
    ...
    public List<Message> aggregatorMessages(String question, String agentResultContext) {
        String system = """
                ...
                - 근거에 `고객명`이 있으면 답변 전체에서 '고객님' 대신 반드시 '해당이름 고객님' 형태로 부르세요. 예: '정하늘 고객님'.
                - 첫 문장은 고객 질문을 반복하지 말고, 공감과 확인 의사를 함께 표현하세요.
                - 금지 예시: "배송이 안 와요. 주문번호 DLV-1001입니다."
                - 권장 예시: "배송이 지연되어 많이 답답하셨을 것 같습니다."
